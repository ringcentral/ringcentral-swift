import Foundation
import ObjectMapper
open class PhoneNumberInfoConferencing: Mappable {
    /*
    Information on a home country of a conference phone number
    */
    open var `country`: GetCountryInfoConferencing?
    /*
    ...
    */
    ...
    convenience public init(country: GetCountryInfoConferencing? = nil, default: Bool? = nil, hasGreeting: Bool? = nil, location: String? = nil, phoneNumber: String? = nil) {
        self.init()
