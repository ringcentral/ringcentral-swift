import Foundation
import ObjectMapper
open class ExtensionCreationResponse: Mappable {
    /*
    ...
    */
    ...
    convenience public init(id: Int? = nil, uri: String? = nil, contact: ContactInfo? = nil, extensionNumber: String? = nil, name: String? = nil, partnerId: String? = nil, permissions: ExtensionPermissions? = nil, profileImage: ProfileImageInfo? = nil, references: [ReferenceInfo]? = nil, roles: [Roles]? = nil, regionalSettings: RegionalSettings? = nil, serviceFeatures: [ExtensionServiceFeatureInfo]? = nil, setupWizardState: String? = nil, status: String? = nil, statusInfo: ExtensionStatusInfo? = nil, type: String? = nil, hidden: Bool? = nil) {
        self.init()
        self.id = `id`
        self.uri = `uri`
