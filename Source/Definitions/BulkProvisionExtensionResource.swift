import Foundation
import ObjectMapper
open class BulkProvisionExtensionResource: Mappable {
    /*
    */
    open var `uri`: String?
    /*
    ...
    */
    ...
    convenience public init(uri: String? = nil, id: String? = nil, partnerId: String? = nil, extensionNumber: String? = nil, loginName: String? = nil, contact: ContactInfo? = nil, references: [Reference]? = nil, name: String? = nil, type: String? = nil, status: String? = nil, statusInfo: StatusInfo? = nil, departments: [DepartmentResource]? = nil, serviceFeatures: [ServiceFeatureValue]? = nil, regionalSettings: RegionalSettingsResource? = nil, setupWizardState: String? = nil, permissions: ExtensionPermissionsResource? = nil, password: String? = nil, ivrPin: String? = nil, profileImage: ProfileImageResource? = nil) {
        self.init()
        self.uri = `uri`
        self.id = `id`
