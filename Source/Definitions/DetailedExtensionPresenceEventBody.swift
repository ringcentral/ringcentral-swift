import Foundation
import ObjectMapper
open class DetailedExtensionPresenceEventBody: Mappable {
    /*
    ...
    */
    open var `activeCalls`: [ActiveCallInfoWithoutSIP]?
    /*
