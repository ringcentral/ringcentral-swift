import Foundation
import ObjectMapper
open class NotificationRecipientInfo: Mappable {
    /*
    ...
    */
    ...
    convenience public init(phoneNumber: String? = nil, extensionNumber: String? = nil, target: Bool? = nil, location: String? = nil, name: String? = nil) {
        self.init()
