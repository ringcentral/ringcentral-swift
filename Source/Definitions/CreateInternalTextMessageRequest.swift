import Foundation
import ObjectMapper
open class CreateInternalTextMessageRequest: Mappable {
    /*
    Sender of a pager message. The extensionNumber property must be filled
    */
    open var `from`: PagerCallerInfoRequest?
    /*
    ...
    */
    open var `to`: [PagerCallerInfoRequest]?
    public init() {
    }
    required public init?(map: Map) {
    }
    convenience public init(from: PagerCallerInfoRequest? = nil, replyOn: Int? = nil, text: String? = nil, to: [PagerCallerInfoRequest]? = nil) {
        self.init()
        self.from = `from`
