import Foundation
import ObjectMapper
open class ReportingSchedulesInfo: Mappable {
    /*
    ...
    */
    open var `recurrence`: [ReportingRecurrenceInfo]?
    /*
    ...
    */
    open var `attachments`: [ReportingAttachmentInfo]?
    /*
    ...
    */
    ...
    convenience public init(scheduleId: String? = nil, recurrence: [ReportingRecurrenceInfo]? = nil, viewType: String? = nil, attachments: [ReportingAttachmentInfo]? = nil, pages: [String]? = nil, recipients: [String]? = nil) {
        self.init()
