...
open class InstantMessageEvent: Mappable {
    ...
    */
    open var `body`: InstantMessageEventBody?
    public init() {
    }
    required public init?(map: Map) {
    }
    convenience public init(uuid: String? = nil, event: String? = nil, timestamp: String? = nil, subscriptionId: String? = nil, body: InstantMessageEventBody? = nil) {
        self.init()
        self.uuid = `uuid`
        self.event = `event`
