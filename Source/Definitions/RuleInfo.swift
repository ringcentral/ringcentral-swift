...
open class RuleInfo: Mappable {
    ...
    */
    open var `forwardingNumbers`: [ForwardingNumberInfoRules]?
    public init() {
    }
    required public init?(map: Map) {
    }
    convenience public init(index: Int? = nil, ringCount: Int? = nil, forwardingNumbers: [ForwardingNumberInfoRules]? = nil) {
        self.init()
        self.index = `index`
