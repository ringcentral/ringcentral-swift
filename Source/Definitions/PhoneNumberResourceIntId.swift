import Foundation
import ObjectMapper
open class PhoneNumberResourceIntId: Mappable {
    /*
    ...
    */
    ...
    convenience public init(id: Int? = nil, country: CountryResource? = nil, extension: ExtensionResource? = nil, label: String? = nil, location: String? = nil, paymentType: String? = nil, phoneNumber: String? = nil, status: String? = nil, usageType: String? = nil, type: String? = nil) {
        self.init()
        self.id = `id`
