...
open class ExtensionListEvent: Mappable {
    ...
    */
    open var `body`: ExtensionListEventBody?
    public init() {
    }
    required public init?(map: Map) {
    }
    convenience public init(uuid: String? = nil, event: String? = nil, timestamp: String? = nil, subscriptionId: String? = nil, body: ExtensionListEventBody? = nil) {
        self.init()
        self.uuid = `uuid`
        self.event = `event`
