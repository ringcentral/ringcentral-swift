import Foundation
import ObjectMapper
open class NotificationSettingsUpdateRequest: Mappable {
    /*
    ...
    */
    ...
    convenience public init(emailAddresses: [String]? = nil, smsEmailAddresses: [String]? = nil, advancedMode: Bool? = nil, voicemails: VoicemailsInfo? = nil, inboundFaxes: InboundFaxesInfo? = nil, outboundFaxes: OutboundFaxesInfo? = nil, inboundTexts: InboundTextsInfo? = nil, missedCalls: MissedCallsInfo? = nil) {
        self.init()
