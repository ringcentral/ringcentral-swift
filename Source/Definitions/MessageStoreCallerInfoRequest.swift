import Foundation
import ObjectMapper
open class MessageStoreCallerInfoRequest: Mappable {
    /*
    ...
    */
    ...
    convenience public init(extensionNumber: String? = nil, location: String? = nil, name: String? = nil, phoneNumber: String? = nil) {
        self.init()
