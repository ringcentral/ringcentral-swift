import Foundation
import ObjectMapper
open class GetConferencingInfoResponse: Mappable {
    /*
    ...
    */
    open var `phoneNumbers`: [PhoneNumberInfoConferencing]?
    public init() {
    }
    required public init?(map: Map) {
    }
    convenience public init(uri: String? = nil, allowJoinBeforeHost: Bool? = nil, hostCode: String? = nil, mode: String? = nil, participantCode: String? = nil, phoneNumber: String? = nil, tapToJoinUri: String? = nil, phoneNumbers: [PhoneNumberInfoConferencing]? = nil) {
        self.init()
        self.uri = `uri`
